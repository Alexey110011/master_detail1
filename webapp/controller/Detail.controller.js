/*global location */
sap.ui.define([
		"zjblessons/MasterTemplate/controller/BaseController",
		"sap/ui/model/json/JSONModel",
		"zjblessons/MasterTemplate/model/formatter",
		"sap/m/MessageToast"
	], function (BaseController, JSONModel, formatter, MessageToast) {
		"use strict";

		return BaseController.extend("zjblessons.MasterTemplate.controller.Detail", {
			...
			_onCalculateBYN : function (oItem){
				...
				jQuery.ajax({
					...
					success : function (data){
						console.log(data)
						var toast_msg = "Cтоимость товарa в BYN по курсу" + " " 
