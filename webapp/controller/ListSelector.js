sap.ui.define([
		...
		"use strict";
		return BaseObject.extend("zjblessons.MasterTemplate.controller.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias zjblessons.MasterTemplate.controller.ListSelector
			 */
			 ...
			 * @return {zjblessons.MasterTemplate.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
