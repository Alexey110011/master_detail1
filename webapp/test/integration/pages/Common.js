sap.ui.define([
	...
	function getFrameUrl (sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("zjblessons/MasterTemplate/app", ".html");
		sHash = sHash || "";
	...
	return Opa5.extend("zjblessons.MasterTemplate.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["zjblessons/MasterTemplate/localService/mockserver"], function (mockserver) {
